	...
	<div class="container">
		...
		<div class="nav-scroller py-1 mb-2">
			<nav class="nav d-flex justify-content-between">
				<a class="p-2 link-secondary g-daily" id="A" href="GenreList.do?genre=daily">일 상</a> <a
					class="p-2 link-secondary g-drama" id="A" href="GenreList.do?genre=drama">드 라 마</a> <a
					class="p-2 link-secondary g-action" id="A" href="GenreList.do?genre=action">액 션</a> <a
